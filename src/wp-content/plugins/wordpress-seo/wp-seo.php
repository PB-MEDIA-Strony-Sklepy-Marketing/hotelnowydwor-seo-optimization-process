...
add_filter( 'wpseo_indexing_get_unindexed_count', '__return_zero' );
add_filter( 'wpseo_indexing_get_limited_unindexed_count', '__return_zero' );
add_filter( 'wpseo_indexing_get_limited_unindexed_count_background', '__return_zero' );
