...
== Description ==
A pack of missing features from the Oxygen builder; copy paste elements and styles, lock classes, enhanced structure panel, 60+ customizable shortcuts, sandbox mode, and more handy tools to improve your workflow!
...
-   Fix: Copy/Paste compatibility issues with Oxygen builder 4.9

= 1.6.1 - October 1, 2024 =

-   Fix: Missing structure panel icons
-   Fix: Dynamic properties deprecation warning in PHP 8.2+
-   Fix: Cleanup unused code from previous version

= 1.6.0 - September 30, 2024 =

-   New: Right-click menu on the structure panel
-   Fix: Right-click menu compatibility with Oxygen builder 4.9
-   Upgraded dependencies to their latest version.

= 1.5.0 - December 27, 2023 =

-   Fix: Compatibility issues with Oxygen builder 4.8

= 1.4.4 - September 6, 2023 =

-   Fix: Other compatibility issues with Oxygen builder 4.7 code editor

= 1.4.3 - August 29, 2023 =

-   Fix: Compatibility issues with Oxygen builder 4.7 code editor
-   Fix: Upgraded Freemius SDK to the latest version.

= 1.4.2 - August 25, 2023 =
...
-   Fix: Compatibility issues with Oxygen builder 4.0
-   Fix: Edit locking interceptor conflicts with some AJAX requests

= 1.3.10 - February 26, 2022 =

-   Fix: Minor security issues

= 1.3.9 - December 8, 2021 =

-   Fix: Double-click to rename user experience improvements

= 1.3.8 - November 29, 2021 =

-   Fix: Move elements up/down shortcuts compatibility issues with Oxygen 3.9

= 1.3.7 - November 29, 2021 =

-   Fix: copy/paste compatibility issues with Oxygen 3.9
-   Fix: copy style overrides non-style options of some components

= 1.3.6 - November 27, 2021 =

-   New: Redesigned structure panel icons
-   Fix: Compatibility of structure panel enhancements with Oxygen 3.9 changes
-   Fix: The save shortcut didn't apply code changes before saving
-   Fix: Colors were replaced with undefined if they don't exist in copied data

= 1.3.5 - June 15, 2021 =

-   Fixed: Preserve advanced tabs break inline text editing

= 1.3.4 - June 14, 2021 =

-   New: option to require Alt/Option key to preserve advanced tabs state

= 1.3.3 - June 14, 2021 =

-   Fixed: UI regression from the 1.3.2 that affected the conditions' dynamic data popup

= 1.3.2 - June 13, 2021 =

-   Improved: the preserve advanced tabs state feature to behave as expected
-   Fixed: conflict between query builder and the enhanced conditions' dialog feature
